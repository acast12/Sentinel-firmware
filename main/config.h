...
#if USE_LOCAL_BROKER
    #define ACTIVE_BROKER_URI MOSQUITTO_BROKER_URI
    #define ACTIVE_USERNAME MOSQUITTO_USERNAME
    #define ACTIVE_PASSWORD MOSQUITTO_PASSWORD
#else
    #define ACTIVE_BROKER_URI MQTT_BROKER_URI
    #define ACTIVE_USERNAME MQTT_USERNAME
    #define ACTIVE_PASSWORD MQTT_PASSWORD
#endif